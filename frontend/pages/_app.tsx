...
// NOTE: Adjust paths if your directory structure is different
...
export default function HomePage() {
  ...
  useEffect(() => {
    // Only set the state once and only on the client
  ...
  return (
    <>
      {/* 1. Head Component for Page-Specific SEO */}
      <Head>
      ...
      <nav>
        ...
        <div className="nav-links">
          {/* Note: In a real project, consider using Link for hash links too for consistency */}
      ...
      {/* Market Ticker (Stray semicolon removed) */}
      ...
      <section className="social-proof">
        <div className="wooden-frame">
          <div className="wooden-inner">
            ...
            {/* 2. Attach the statsRef here to observe intersection */}
            <div className="stats-grid" ref={statsRef}> 
              <div className="stat-card">
                <div className="stat-number" suppressHydrationWarning={true}>
                  {/* 3. Use the AnimatedCounter component, rendered conditionally */}
              ...
              <div className="stat-card">
                {/* Fixed values without animation */}
