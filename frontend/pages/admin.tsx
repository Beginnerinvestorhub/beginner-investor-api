          ...
          <div className="text-center">
            ...
            <div className="relative w-24 h-24 mx-auto mb-6">
              ...
              <div className="absolute inset-0 animate-spin-reverse opacity-60">
                <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" className="text-blue-600 w-full h-full">
            ...
            <p className="text-lg font-semibold text-gray-900 mb-2">Initializing System</p>
        ...
        <div className="nyse-container relative z-10">
          ...
          <div className="text-center mb-12 relative">
            ...
            <div className="absolute -top-6 left-0 w-20 h-20 opacity-10 animate-spin-slow">
              <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" className="text-red-900">
                <circle cx="50" cy="50" r="40" strokeWidth="2"/>
                <circle cx="50" cy="50" r="25" strokeWidth="2"/>
                {[...Array(8)].map((_, i) => (
                  <line
            ...
            <div className="inline-flex items-center px-4 py-2 bg-red-50 border border-red-200 rounded-lg mb-4">
              ...
              <span className="text-sm text-red-900 font-medium">Restricted Access - Admin Only</span>
            </div>
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              <span className="font-semibold text-blue-900">Master Engineering Console:</span> Monitor all system components, 
              user assemblies, and operational metrics. Deploy administrative controls with precision authority.
            </p>
          </div>
          ...
          <div className="mb-8 flex flex-wrap items-center justify-center gap-4">
            <div className={`inline-flex items-center px-4 py-2 rounded-lg border ${
              ...
              <div className={`w-2 h-2 rounded-full mr-2 animate-pulse ${
                adminData.systemHealth === 'healthy' ? 'bg-green-500' : 'bg-red-500'
              }`}></div>
              <span className={`text-sm font-medium ${
                adminData.systemHealth === 'healthy' ? 'text-green-900' : 'text-red-900'
              }`}>
                System {adminData.systemHealth === 'healthy' ? 'Operational' : 'Alert'}
              </span>
            </div>
            <div className="inline-flex items-center px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <span className="text-sm text-blue-900 font-medium">Admin: {user?.email || 'Administrator'}</span>
            </div>
          </div>
          ...
          <div className="nyse-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <button className="nyse-btn nyse-btn-secondary text-left p-6 flex items-start space-x-4 h-auto">
                ...
                <div>
                  <div className="font-bold text-gray-900 mb-1">User Management</div>
              ...
              <button className="nyse-btn nyse-btn-secondary text-left p-6 flex items-start space-x-4 h-auto">
                ...
                <div>
                  <div className="font-bold text-gray-900 mb-1">System Analytics</div>
              ...
              <button className="nyse-btn nyse-btn-secondary text-left p-6 flex items-start space-x-4 h-auto">
                ...
                <div>
                  <div className="font-bold text-gray-900 mb-1">System Configuration</div>
                  <p className="text-sm text-gray-600">Adjust system settings and parameters</p>
                </div>
              </button>
              ...
              <button className="nyse-btn nyse-btn-secondary text-left p-6 flex items-start space-x-4 h-auto">
                ...
                <div>
                  <div className="font-bold text-gray-900 mb-1">Security Logs</div>
                  <p className="text-sm text-gray-600">Review system security events</p>
                </div>
              </button>
              ...
              <button className="nyse-btn nyse-btn-secondary text-left p-6 flex items-start space-x-4 h-auto">
                ...
                <div>
                  <div className="font-bold text-gray-900 mb-1">Database Management</div>
                  <p className="text-sm text-gray-600">Backup and maintenance operations</p>
                </div>
              </button>
              ...
              <button className="nyse-btn nyse-btn-secondary text-left p-6 flex items-start space-x-4 h-auto">
                ...
                <div>
                  <div className="font-bold text-gray-900 mb-1">System Reports</div>
                  <p className="text-sm text-gray-600">Generate and export system reports</p>
                </div>
              </button>
            </div>
          </div>
