    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12 px-4">
        ...
        <div className="fixed inset-0 pointer-events-none opacity-5" style={{
          backgroundImage: 'linear-gradient(rgba(0, 61, 122, 0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 61, 122, 0.3) 1px, transparent 1px)',
        ...
        <div className="nyse-container relative z-10">
          ...
          <div className="text-center mb-12 relative">
            ...
            <div className="absolute -top-6 left-4 w-20 h-20 opacity-10 animate-spin-slow">
              <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" className="text-green-900">
            ...
            <div className="absolute top-2 right-8 w-16 h-16 opacity-10 animate-spin-reverse">
              <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" className="text-blue-900">
            ...
            <div className="absolute top-20 right-0 w-14 h-14 opacity-10 animate-spin-slower">
              <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" className="text-green-800">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              <span className="font-semibold text-blue-900">Sustainable Investment Filter:</span> Screen and construct portfolios 
              using Environmental, Social, and Governance criteria. Detect component integrity issues, sector classifications, 
              and risk indicators with precision engineering.
            </p>
          </div>
          ...
          <div className="mb-8 flex flex-wrap items-center justify-center gap-4">
            <div className="inline-flex items-center px-4 py-2 bg-green-50 border border-green-200 rounded-lg">
              ...
              <span className="text-sm text-green-900 font-medium">Environmental</span>
            </div>
            ...
            <div className="inline-flex items-center px-4 py-2 bg-purple-50 border border-purple-200 rounded-lg">
              ...
              <span className="text-sm text-purple-900 font-medium">Governance</span>
            </div>
            <div className="inline-flex items-center px-4 py-2 bg-amber-50 border border-amber-200 rounded-lg">
              <svg className="w-5 h-5 text-amber-900 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <span className="text-sm text-amber-900 font-medium">Risk Detection</span>
            </div>
          </div>
            ...
            <div className="mb-8 pb-6 border-b border-gray-200">
              <div className="flex items-start justify-between flex-wrap gap-4">
                ...
                <div className="flex items-center space-x-2 px-3 py-1.5 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <span className="text-sm text-green-900 font-medium">Real-Time Screening</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 nyse-card bg-gradient-to-br from-green-50 to-white">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Our multi-stage verification process ensures component authenticity:</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="relative pl-8">
                ...
                <div className="font-semibold text-gray-900 mb-1">Filter Criteria</div>
                <p className="text-sm text-gray-600">Apply ESG parameters and sector specifications to component database.</p>
              </div>
              <div className="relative pl-8">
                ...
                <div className="font-semibold text-gray-900 mb-1">Integrity Test</div>
                <p className="text-sm text-gray-600">Scan for red flags, greenwashing indicators, and risk anomalies.</p>
              </div>
              <div className="relative pl-8">
                ...
                <div className="font-semibold text-gray-900 mb-1">Visualize Data</div>
                <p className="text-sm text-gray-600">Generate technical blueprints and performance visualizations.</p>
              </div>
              <div className="relative pl-8">
                ...
                <p className="text-sm text-gray-600">Export validated components for portfolio construction.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="nyse-card hover:shadow-lg transition-shadow bg-white">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Greenwashing Detection</h3>
                  <p className="text-sm text-gray-600">Advanced algorithms identify misleading sustainability claims and verify authentic ESG commitments.</p>
                </div>
              </div>
            </div>
            ...
            <div className="nyse-card hover:shadow-lg transition-shadow bg-white">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Real-Time Scanning</h3>
                  <p className="text-sm text-gray-600">Continuously monitor securities against the latest ESG standards and regulatory frameworks.</p>
                </div>
              </div>
            </div>
            ...
            <div className="nyse-card hover:shadow-lg transition-shadow bg-white">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Sector Intelligence</h3>
                  <p className="text-sm text-gray-600">Cross-reference sector classifications with risk profiles for comprehensive due diligence.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg">
              <svg className="w-5 h-5 text-green-700 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
