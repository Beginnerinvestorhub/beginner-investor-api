        ...
        <div className="nyse-container relative z-10">
          ...
          <div className="text-center mb-12 relative">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              <span className="font-semibold text-blue-900">Assembly Instructions:</span> Answer a few questions about your background, finances, and goals. 
              Get a personalized risk score and asset allocation recommendation—constructed with precision and delivered instantly.
            </p>
          </div>
          ...
          {!result ? (
            <div className="nyse-card">
              <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <p className="text-gray-600">
                  Complete the component assembly below to construct your personalized investment blueprint.
                </p>
              </div>
              <RiskAssessmentForm
                onSubmit={async (formData) => {
                  ...
                  try {
                    ...
                    setError(e.message || 'Failed to assess risk. Please verify all components and try again.');
                  } finally {
                    setLoading(false);
                  }
                }}
            ...
            <div className="nyse-card">
              <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <p className="text-gray-600">
                  Assembly complete. Review your personalized specifications below.
                </p>
              </div>
