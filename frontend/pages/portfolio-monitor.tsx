        ...
        <div className="nyse-container relative z-10">
          ...
          <header className="text-center mb-12 relative">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              <span className="font-semibold text-blue-900">Real-Time Assembly Monitor:</span> Visualize your portfolio allocation, 
              performance metrics, and component details. Deploy alerts and track your investment architecture in real time.
            </p>
          </header>
          ...
          <div className="mb-8 flex flex-wrap items-center justify-center gap-4">
            <div className="inline-flex items-center px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <span className="text-sm text-blue-900 font-medium">System Operational</span>
            </div>
            <div className="inline-flex items-center px-4 py-2 bg-green-50 border border-green-200 rounded-lg">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span className="text-sm text-green-900 font-medium">Live Data Stream</span>
            </div>
            <div className="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg">
              ...
              <span className="text-sm text-gray-700 font-medium">Secure Connection</span>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Monitor all portfolio components and performance metrics in your investment mechanism.
                  </p>
                </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4 bg-white border border-gray-200 rounded-lg">
              <div className="text-3xl font-bold text-blue-900 mb-1" style={{ fontFamily: 'Georgia, serif' }}>
                📊
              </div>
              <div className="text-sm font-semibold text-gray-900 mb-1">Real-Time Analytics</div>
              <div className="text-xs text-gray-600">Performance tracking engine</div>
            </div>
            <div className="p-4 bg-white border border-gray-200 rounded-lg">
              <div className="text-3xl font-bold text-blue-900 mb-1" style={{ fontFamily: 'Georgia, serif' }}>
                🔔
              </div>
              <div className="text-sm font-semibold text-gray-900 mb-1">Alert Mechanisms</div>
              <div className="text-xs text-gray-600">Automated notification system</div>
            </div>
            <div className="p-4 bg-white border border-gray-200 rounded-lg">
              <div className="text-3xl font-bold text-blue-900 mb-1" style={{ fontFamily: 'Georgia, serif' }}>
                🔧
              </div>
              <div className="text-sm font-semibold text-gray-900 mb-1">Precision Engineering</div>
              <div className="text-xs text-gray-600">Enterprise-grade accuracy</div>
            </div>
          </div>
        </div>
