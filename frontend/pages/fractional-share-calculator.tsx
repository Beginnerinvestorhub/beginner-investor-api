        ...
        <div className="nyse-container relative z-10">
          ...
          <div className="text-center mb-12 relative">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              <span className="font-semibold text-blue-900">Precision Engineering Tool:</span> Enter an investment amount and stock price 
              to construct your fractional share assembly. Compare component costs across brokers and visualize your calculated purchase blueprint.
            </p>
          </div>
          ...
          <section className="nyse-card">
            ...
            <div className="mb-8 pb-6 border-b border-gray-200">
              ...
              <p className="text-gray-600">
                Configure your investment parameters below to construct your fractional share specifications.
              </p>
            </div>
          ...
          <div className="mt-12 nyse-card bg-gradient-to-br from-blue-50 to-white">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Follow these steps to construct your fractional share calculation:</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="relative pl-8">
                ...
                <p className="text-sm text-gray-600">Enter your investment amount and target stock price into the calculation engine.</p>
              </div>
              <div className="relative pl-8">
                <div className="absolute left-0 top-0 w-6 h-6 bg-blue-900 text-white rounded-full flex items-center justify-center text-sm font-bold">
                  2
                ...
                <p className="text-sm text-gray-600">System calculates precise fractional shares and compares broker fee structures.</p>
              </div>
              <div className="relative pl-8">
                <div className="absolute left-0 top-0 w-6 h-6 bg-blue-900 text-white rounded-full flex items-center justify-center text-sm font-bold">
                  3
                ...
                <p className="text-sm text-gray-600">Review visual blueprints and detailed cost analysis for informed decision-making.</p>
              </div>
            </div>
          </div>
