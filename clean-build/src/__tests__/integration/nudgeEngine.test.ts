...
describe('Nudge Engine API Integration Tests', () => {
    ...
    describe('POST /api/nudge', () => {
        ...
        it('should handle service errors gracefully', async () => {
            ...
            jest.spyOn(cacheService, 'getCachedNudge').mockRejectedValueOnce(new Error('Cache error'));
    ...
    describe('Error Recovery', () => {
        it('should serve cached response when primary service fails', async () => {
            ...
            // Mock a service failure
            jest.spyOn(cacheService, 'getCachedNudge').mockRejectedValueOnce(new Error('Service unavailable'));
