...
describe("BadgeService", () => {
  ...
  beforeEach(() => {
    ...
    mockPrismaGamificationResponses.badge.findMany.mockResolvedValue([
      mockBadge,
    ]);
  ...
  describe("awardBadge", () => {
    ...
    it("should not award duplicate badges by default", async () => {
      ...
      mockPrismaGamificationResponses.badge.findUnique.mockResolvedValueOnce(
        mockBadge,
      );
      ...
      expect(
        mockPrismaGamificationResponses.badge.create,
  ...
  describe("getUserBadges", () => {
    it("should get all badges for a user", async () => {
      ...
      expect(
        mockPrismaGamificationResponses.badge.findMany,
